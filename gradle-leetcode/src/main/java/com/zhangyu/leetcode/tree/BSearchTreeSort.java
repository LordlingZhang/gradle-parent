...
public class BSearchTreeSort {
    ...
    public static void main(String[] args) {
        LinkedList<Integer> a = new LinkedList(Arrays.asList(6, 3,2,1,null,null,null,4,null,null,8,7,null,null,9,null,null));
        ...
        System.out.println("节点:"+ findNode.getData() + "  左节点:" + (findNode.getLNode() == null ? "null" : findNode.getLNode().getData()) + "  右节点:" + (findNode.getRNode() == null ? "null" : findNode.getRNode().getData()));
        // 替换
        treeSort.insert(5);
        System.out.println();
    }
